...
export const TOOLS: Anthropic.Tool[] = [
  ...
  },
  {
    ...
    description: [
      ...
      '',
      '## NO IMPORTS',
      'The exec sandbox uses restricted builtins — `import` statements raise `ImportError: __import__ not found` and your script SILENTLY FAILS. NEVER write `import bmesh`, `import bpy`, `from mathutils import Vector`, etc. They are already injected as `bmesh`, `bpy`, `math`, `Vector`.',
      '',
      '## Return value',
